...
struct List {
    ...
    void insert(Node** list, string data) {
    ...
    void insert(Node** previous, Node** selected, Node** list, string data) {
        Node* newnode = new Node(data);
        if (*previous) {
    ...
    void del_value(Node** next, Node** previous, string data) {
...
void ADD_ACT(List* l, string data) { l->insert(&l->leading, &l->selected, &l->head, data); }
...
void DEL_VAL(List* l, string data) { l->del_value(&l->trailing, &l->leading, data); }
